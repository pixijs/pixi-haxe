...
samples_movieclip_Main.__name__ = true;
...
samples_movieclip_Main.prototype = $extend(pixi_plugins_app_Application.prototype,{
	_init: function() {
		...
		mcloader.add("explosion","assets/movieclip/luckyplayer.json");
	...
	,_onLoaded: function() {
		...
		while(_g2 < 32) {
			var i2 = _g2++;
			var baseName = "luckyglow00";
			if(i2 < 9) baseName += "0";
			texture1 = PIXI.Texture.fromFrame(baseName + (i2 + 1) + ".png");
			explosionTextures.push(texture1);
		}
		var explosion1 = new PIXI.extras.MovieClip(explosionTextures);
		explosion1.position.set(100,100);
		explosion1.gotoAndPlay(0);
		this._stage.addChild(explosion1);
		explosion1 = new PIXI.extras.MovieClip(explosionTextures);
		explosion1.position.set(100,300);
		explosion1.tint = 16711680;
		explosion1.gotoAndPlay(0);
		this._stage.addChild(explosion1);
	}
});
