...
samples_loader_Main.__name__ = true;
...
samples_loader_Main.prototype = $extend(pixi_plugins_app_Application.prototype,{
	...
	,_onLoadProgress: function() {
		haxe_Log.trace("Loaded: " + Math.round(this._loader.progress),{ fileName : "Main.hx", lineNumber : 34, className : "samples.loader.Main", methodName : "_onLoadProgress"});
	}
	,_onLoaded: function() {
