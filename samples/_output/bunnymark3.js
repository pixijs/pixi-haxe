...
var samples = {};
samples.bunnymark3 = {};
samples.bunnymark3.Bunny = function(texture) {
	PIXI.Sprite.call(this,texture);
};
samples.bunnymark3.Bunny.__super__ = PIXI.Sprite;
samples.bunnymark3.Bunny.prototype = $extend(PIXI.Sprite.prototype,{
});
samples.bunnymark3.Main = function() {
...
samples.bunnymark3.Main.main = function() {
	new samples.bunnymark3.Main();
};
samples.bunnymark3.Main.__super__ = pixi.plugins.app.Application;
samples.bunnymark3.Main.prototype = $extend(pixi.plugins.app.Application.prototype,{
	_init: function() {
	...
	,_addBunnys: function() {
		...
		while(_g < 10) {
			var i = _g++;
			this._bunny = new samples.bunnymark3.Bunny(this._bunnyTexture);
	...
	,_updateQuanityLabel: function() {
		this._quantityLabel.text = "Quantity: " + this._sprites.length;
	}
});
var $_, $fid = 0;
...
samples.bunnymark3.Main.main();
})();

//# sourceMappingURL=bunnymark3.js.map