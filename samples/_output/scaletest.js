...
scaletest_Main.prototype = $extend(pixi_plugins_app_Application.prototype,{
	_init: function() {
		var scale = this._getScale(480);
		this.position = "fixed";
		this.backgroundColor = 16777215;
		this.pixelRatio = this._pr;
		this.onResize = $bind(this,this._onResize);
		pixi_plugins_app_Application.prototype.start.call(this);
		var bgPath = "assets/scaletest/scale-" + scale + "/background/images/background.png";
		var reelspath = "assets/scaletest/scale-" + scale + "/symbols/images/symbols.png";
		this._bg = new PIXI.Sprite(PIXI.Texture.fromImage(bgPath));
		...
		this._reels = new PIXI.Sprite(PIXI.Texture.fromImage(reelspath));
		...
		this._label.text = "Scale: " + scale + " DPR: " + this._pr;
	}
