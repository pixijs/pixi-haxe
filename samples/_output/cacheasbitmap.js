...
var samples_cacheasbitmap_Main = function() {
	pixi_plugins_app_Application.call(this);
	this._init();
};
samples_cacheasbitmap_Main.main = function() {
	new samples_cacheasbitmap_Main();
};
samples_cacheasbitmap_Main.__super__ = pixi_plugins_app_Application;
samples_cacheasbitmap_Main.prototype = $extend(pixi_plugins_app_Application.prototype,{
	_init: function() {
...
samples_cacheasbitmap_Main.main();
