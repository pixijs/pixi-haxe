...
extern class Text extends Sprite {
	 ...
	 * @param [style.letterSpacing=0] {Float} The amount of spacing between letters, default is 0
	 * @param [style.breakWords=false] {Bool} Indicates if lines can be wrapped within words, it needs wordWrap to be set to true
	 ...
	 * @param [style.dropShadowBlur=0] {Float} Set a shadow blur radius
